	...
	public class MGlobalNPC : GlobalNPC
	{
		...
		public override void ModifyNPCLoot(NPC npc, NPCLoot npcLoot)
		{
			...
			if (npc.type != NPCID.MotherSlime && npc.type != NPCID.CorruptSlime && npc.type != NPCID.Slimer && npc.lifeMax > 1 && npc.damage > 0)
			{
				...
				npcLoot.Add(ItemDropRule.ByCondition(new ItemDropRules.Conditions.UniversalAmmoCondition(), ModContent.ItemType<Content.Items.Miscellaneous.UAPickup>(), 15, 5, 10));
