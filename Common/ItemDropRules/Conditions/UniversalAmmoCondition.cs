...
namespace MetroidMod.Common.ItemDropRules.Conditions
{
	public class UniversalAmmoCondition : IItemDropRuleCondition
	{
		public bool CanDrop(DropAttemptInfo info)
		{
			...
			{
				if (info.player.inventory[i].type == ModContent.ItemType<Content.Items.Weapons.PowerBeam>() || info.player.inventory[i].type == ModContent.ItemType<Content.Items.Weapons.ArmCannon>())
				{
					flag = true;
					break;
				}
