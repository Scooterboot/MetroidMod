...
namespace MetroidMod.Tiles
{
	public class RedHatch : ModTile
	{
        ...
        public override bool PreDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Main.spriteBatch.Draw(mod.GetTexture("Tiles/RedHatchDoor"), new Vector2((i - 1) * 16 - (int)Main.screenPosition.X, j * 16 - (int)Main.screenPosition.Y) + zero, new Rectangle(tile.frameX, tile.frameY, 48, 16), Color.White, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
            return true;
        }
    }
}