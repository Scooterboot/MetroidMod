...
{
	public class BlueHatchOpenVertical : ModTile
	{
	...
	/*	public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
		{
			...
			Main.spriteBatch.Draw(mod.GetTexture("Tiles/BlueHatchDoorOpen"), new Vector2((i - 1) * 16 - (int)Main.screenPosition.X, j * 16 - (int)Main.screenPosition.Y) + zero, new Rectangle(tile.frameX + 18, tile.frameY * timez, 16, height), Color.White, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
		}*/
