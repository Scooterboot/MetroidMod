...
namespace MetroidMod.NPCs.GoldenTorizo
{
    public class GoldenTorizo : ModNPC
    {
		...
		NPC Head
		{
			get
			{
				if(Main.npc[_head].type == mod.NPCType("GoldenTorizo_HitBox") && Main.npc[_head].ai[1] == 0f)
				{
		...
		public override bool PreAI()
		{
			...
			if(!initialized && Main.netMode != NetmodeID.MultiplayerClient)
			{
				...
				_body = NPC.NewNPC((int)BodyPos[1].X,(int)BodyPos[1].Y,mod.NPCType("GoldenTorizo_HitBox"),npc.whoAmI, npc.whoAmI,1f);
				
				for(int i = 0; i < 2; i++)
				{
					_rArm[i] = NPC.NewNPC((int)RArmPos[i+3].X,(int)RArmPos[i+3].Y,mod.NPCType("GoldenTorizo_HitBox"),npc.whoAmI, npc.whoAmI,2+i);
					_lArm[i] = NPC.NewNPC((int)LArmPos[i+3].X,(int)LArmPos[i+3].Y,mod.NPCType("GoldenTorizo_HitBox"),npc.whoAmI, npc.whoAmI,2+i);
					_rLeg[i] = NPC.NewNPC((int)RLegPos[i+3].X,(int)RLegPos[i+3].Y,mod.NPCType("GoldenTorizo_HitBox"),npc.whoAmI, npc.whoAmI,5+i);
					_lLeg[i] = NPC.NewNPC((int)LLegPos[i+3].X,(int)LLegPos[i+3].Y,mod.NPCType("GoldenTorizo_HitBox"),npc.whoAmI, npc.whoAmI,5+i);
				}
				
				_rHand = NPC.NewNPC((int)RHandPos[0].X,(int)RHandPos[0].Y,mod.NPCType("GoldenTorizo_HitBox"),npc.whoAmI, npc.whoAmI,4f);
				_lHand = NPC.NewNPC((int)LHandPos[0].X,(int)LHandPos[0].Y,mod.NPCType("GoldenTorizo_HitBox"),npc.whoAmI, npc.whoAmI,4f);
				
				_head = NPC.NewNPC((int)HeadPos[1].X,(int)HeadPos[1].Y,mod.NPCType("GoldenTorizo_HitBox"),npc.whoAmI, npc.whoAmI);
	...
	//	new float[] {    0f,  0f, 20f}};
		...
		public override void AI()
		{
							...
							if(anim_ClawTransition >= 1f)
							{
								...
								if((anim_Claw >= 3f && anim_Claw <= 4f) || (anim_Claw >= 7f && anim_Claw <= 8f))
								{
									...
									for(int i = -1; i < 2; i++)
									{
										...
										int slash = Projectile.NewProjectile(clawPos.X,clawPos.Y,clawVel.X,clawVel.Y,mod.ProjectileType("TorizoSwipe"),(int)((float)clawDamage/2f),8f);
									}
									if(soundCounter <= 0)
									{
										...
										Main.PlaySound(SoundLoader.customSoundType, (int)sndPos.X, (int)sndPos.Y, mod.GetSoundSlot(SoundType.Custom, "Sounds/TorizoSwipe"));
										soundCounter = 4;
									}
								}
								if(anim_Claw >= 8f)
				...
				if(npc.ai[0] == 2)
				{
					...
					if(npc.ai[2] >= 1 && npc.ai[2] <= 2)
					{
						...
						else
						{
							...
							if(!screwBoosted)
							{
								Main.PlaySound(SoundLoader.customSoundType, (int)BodyPos[0].X, (int)BodyPos[0].Y, mod.GetSoundSlot(SoundType.Custom, "Sounds/ScrewAttackSpeedSound"));
								screwBoostAlpha = 2f;
								screwBoosted = true;
							}
						}
					...
					if(npc.ai[1] == 1)
					{
						...
						if((npc.ai[2] == 10 || npc.ai[2] == 20 || npc.ai[2] == 30) && headFlag)
						{
							for(int i = 0; i < 3; i++)
							{
								...
								NPC bomb = Main.npc[NPC.NewNPC((int)bombPos.X,(int)bombPos.Y,mod.NPCType("OrbBomb_Golden"),npc.whoAmI)];
								bomb.Center = bombPos;
			...
			if(screwAttack)
			{
				...
				{
					Main.PlaySound(SoundLoader.customSoundType, (int)BodyPos[0].X, (int)BodyPos[0].Y,  mod.GetSoundSlot(SoundType.Custom, "Sounds/ScrewAttackSound"));
		...
		public override bool PreDraw(SpriteBatch sb, Color drawColor)
		{
			...
			Texture2D texHead = mod.GetTexture("NPCs/GoldenTorizo/GoldenTorizoHead"),
					texHead_Glow = mod.GetTexture("NPCs/GoldenTorizo/GoldenTorizoHead_EyeGlow"),
					texHead_Glow2 = mod.GetTexture("NPCs/GoldenTorizo/GoldenTorizoHead_EyeGlow2"),
					texBody = mod.GetTexture("NPCs/GoldenTorizo/GoldenTorizoBody"),
					texBody_Glow = mod.GetTexture("NPCs/GoldenTorizo/GoldenTorizoBody_Glow"),
					texShoulderF = mod.GetTexture("NPCs/GoldenTorizo/GoldenTorizoShoulder_Front"),
					texShoulderB = mod.GetTexture("NPCs/GoldenTorizo/GoldenTorizoShoulder_Back"),
					texArmF = mod.GetTexture("NPCs/GoldenTorizo/GoldenTorizoArm_Front"),
					texArmB = mod.GetTexture("NPCs/GoldenTorizo/GoldenTorizoArm_Back"),
					texHandF = mod.GetTexture("NPCs/GoldenTorizo/GoldenTorizoHand_Front"),
					texHandB = mod.GetTexture("NPCs/GoldenTorizo/GoldenTorizoHand_Back"),
					texThighF = mod.GetTexture("NPCs/GoldenTorizo/GoldenTorizoLegThigh_Front"),
					texThighB = mod.GetTexture("NPCs/GoldenTorizo/GoldenTorizoLegThigh_Back"),
					texCalfF = mod.GetTexture("NPCs/GoldenTorizo/GoldenTorizoLegCalf_Front"),
					texCalfB = mod.GetTexture("NPCs/GoldenTorizo/GoldenTorizoLegCalf_Back"),
					texFootF = mod.GetTexture("NPCs/GoldenTorizo/GoldenTorizoLegFoot_Front"),
					texFootB = mod.GetTexture("NPCs/GoldenTorizo/GoldenTorizoLegFoot_Back");
			
			Texture2D texSpawnHead = mod.GetTexture("NPCs/GoldenTorizo/Spawn/GoldenTorizoHead"),
					texSpawnHead_Glow = mod.GetTexture("NPCs/GoldenTorizo/Spawn/GoldenTorizoHead_EyeGlow"),
					texSpawnHead_Glow2 = mod.GetTexture("NPCs/GoldenTorizo/Spawn/GoldenTorizoHead_EyeGlow2"),
					texSpawnBody = mod.GetTexture("NPCs/GoldenTorizo/Spawn/GoldenTorizoBody"),
					texSpawnBody_Glow = mod.GetTexture("NPCs/GoldenTorizo/Spawn/GoldenTorizoBody_Glow"),
					texSpawnShoulderF = mod.GetTexture("NPCs/GoldenTorizo/Spawn/GoldenTorizoShoulder_Front"),
					texSpawnShoulderB = mod.GetTexture("NPCs/GoldenTorizo/Spawn/GoldenTorizoShoulder_Back"),
					texSpawnArmF = mod.GetTexture("NPCs/GoldenTorizo/Spawn/GoldenTorizoArm_Front"),
					texSpawnArmB = mod.GetTexture("NPCs/GoldenTorizo/Spawn/GoldenTorizoArm_Back"),
					texSpawnHandF = mod.GetTexture("NPCs/GoldenTorizo/Spawn/GoldenTorizoHand_Front"),
					texSpawnHandB = mod.GetTexture("NPCs/GoldenTorizo/Spawn/GoldenTorizoHand_Back"),
					texSpawnThighF = mod.GetTexture("NPCs/GoldenTorizo/Spawn/GoldenTorizoLegThigh_Front"),
					texSpawnThighB = mod.GetTexture("NPCs/GoldenTorizo/Spawn/GoldenTorizoLegThigh_Back"),
					texSpawnCalfF = mod.GetTexture("NPCs/GoldenTorizo/Spawn/GoldenTorizoLegCalf_Front"),
					texSpawnCalfB = mod.GetTexture("NPCs/GoldenTorizo/Spawn/GoldenTorizoLegCalf_Back"),
					texSpawnFootF = mod.GetTexture("NPCs/GoldenTorizo/Spawn/GoldenTorizoLegFoot_Front"),
					texSpawnFootB = mod.GetTexture("NPCs/GoldenTorizo/Spawn/GoldenTorizoLegFoot_Back");
			if(state == 1)
			{
				texSpawnHead = mod.GetTexture("NPCs/Torizo/TorizoHead");
				texSpawnHead_Glow = mod.GetTexture("NPCs/GoldenTorizo/GoldenTorizoHead_EyeGlow");
				texSpawnHead_Glow2 = mod.GetTexture("NPCs/GoldenTorizo/GoldenTorizoHead_EyeGlow2");
				texSpawnBody = mod.GetTexture("NPCs/Torizo/TorizoBody");
				texSpawnBody_Glow = mod.GetTexture("NPCs/GoldenTorizo/GoldenTorizoBody_Glow");
				texSpawnShoulderF = mod.GetTexture("NPCs/Torizo/TorizoShoulder_Front");
				texSpawnShoulderB = mod.GetTexture("NPCs/Torizo/TorizoShoulder_Back");
				texSpawnArmF = mod.GetTexture("NPCs/Torizo/TorizoArm_Front");
				texSpawnArmB = mod.GetTexture("NPCs/Torizo/TorizoArm_Back");
				texSpawnHandF = mod.GetTexture("NPCs/Torizo/TorizoHand_Front");
				texSpawnHandB = mod.GetTexture("NPCs/Torizo/TorizoHand_Back");
				texSpawnThighF = mod.GetTexture("NPCs/Torizo/TorizoLegThigh_Front");
				texSpawnThighB = mod.GetTexture("NPCs/Torizo/TorizoLegThigh_Back");
				texSpawnCalfF = mod.GetTexture("NPCs/Torizo/TorizoLegCalf_Front");
				texSpawnCalfB = mod.GetTexture("NPCs/Torizo/TorizoLegCalf_Back");
				texSpawnFootF = mod.GetTexture("NPCs/Torizo/TorizoLegFoot_Front");
				texSpawnFootB = mod.GetTexture("NPCs/Torizo/TorizoLegFoot_Back");
			}
			...
			if(screwAttack)
			{
				Texture2D saTex = mod.GetTexture("NPCs/GoldenTorizo/GT_ScrewAttack");
				...
				if(screwBoostAlpha > 0f)
				{
					...
					Texture2D saTex2 = mod.GetTexture("NPCs/GoldenTorizo/GT_ScrewAttack_Yellow"),
							saTex3 = mod.GetTexture("NPCs/GoldenTorizo/GT_ScrewAttack_YellowGlow");
