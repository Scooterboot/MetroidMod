...
{
	internal class LockedHatch : ModTile
	{
		public int otherDoorID = 0;
		public override string Texture => ModContent.GetInstance<BlueHatch>().Texture;
		...
		public override void SetStaticDefaults()
		{
			...
			AddMapEntry(new Color(56, 112, 224), CreateMapEntryName());
			AdjTiles = [TileID.ClosedDoor];

			AddToArray(ref TileID.Sets.RoomNeeds.CountsAsDoor);
			otherDoorID = ModContent.TileType<LockedHatchOpen>();
		}
		...
		public override void MouseOver(int i, int j)
		{
			...
			player.cursorItemIconID = ModContent.ItemType<Items.Tiles.LockedHatch>();
		}
		...
		{
			DrawDoor(i, j, spriteBatch, ModContent.Request<Texture2D>($"{Mod.Name}/Content/Tiles/Hatch/LockedHatchDoor").Value);
			return true;
		}
	...
	internal class LockedHatchOpen : LockedHatch
	{
		public override void SetStaticDefaults()
		{
			Main.tileFrameImportant[Type] = true;
			...
			otherDoorID = ModContent.TileType<LockedHatch>();
		}
