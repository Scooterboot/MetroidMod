...
{
	public class RedHatch : BlueHatch
	{
		public override void SetStaticDefaults()
		{
			...
			otherDoorID = ModContent.TileType<RedHatchOpen>();
        }
        ...
        {
            DrawDoor(i,j,spriteBatch,ModContent.Request<Texture2D>("Content/Tiles/Hatch/RedHatchDoor").Value);
            return true;
        }
    }
}
