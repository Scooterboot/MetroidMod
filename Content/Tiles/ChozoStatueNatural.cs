...
namespace MetroidMod.Content.Tiles
{
	public class ChozoStatueNatural : ModTile
	{
		...
		{
			new EntitySource_TileBreak(i, j); //Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 32, 48, ModContent.ItemType<Items.Tiles.ChoziteOre>(), Main.rand.Next(10, 25));
		}
	}
}
