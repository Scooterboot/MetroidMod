...
namespace MetroidMod.Content.Tiles2.Butter
{
	public class MetalDoorOpen : ModTile
	{
		public override void SetStaticDefaults() 
		{
			...
			TileID.Sets.CloseDoorID[Type] = ModContent.TileType<MetalDoorClosed>();
			...
			RegisterItemDrop(ModContent.ItemType<MetalDoorItem>(), 0);///might need to be "metaldooritem" ---------------------------------------------------------
			TileID.Sets.CloseDoorID[Type] = ModContent.TileType<MetalDoorClosed>();
		...
		public override void MouseOver(int i, int j) {
			...
			player.cursorItemIconID = ModContent.ItemType<MetalDoorItem>();
		}
	}
}
