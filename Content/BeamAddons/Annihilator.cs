...
{
	public class Annihilator : ModBeamAddon
	{
		...
		public override void SetStaticDefaults()
		{
			...
			VIB = true;
			vibOverride = ModContent.ProjectileType<AnnihilatorShot>();
			ArrayPassive = false;
		...
		public override void VIBShoot(Item item, Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback, string bonusFileMod = "", float multiplier = 1)
		{
			...
			AnnihilatorShot tasteTheRainbow = Projectile.NewProjectileDirect(source, position, velocity, ModContent.ProjectileType<AnnihilatorShot>(), damage, knockback).ModProjectile as AnnihilatorShot;
	...
	public class AnnihilatorShot : MProjectile
	{
		public string fileMod = "";
		public override string Texture => $"{Mod.Name}/Assets/Textures/BeamAddons/Annihilator/Shot";
	...
	public class AnnihilatorChargeShot : MProjectile
	{
		public string fileMod = "";
		public override string Texture => $"{Mod.Name}/Assets/Textures/BeamAddons/Annihilator/ShotCharged";
		public ModBeamAddon[] beamAddons = new ModBeamAddon[BeamAddonSlotID.Count - 1];
		public override void SetStaticDefaults()
		{
