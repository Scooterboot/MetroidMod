...
{
	public class LightBeam : ModBeamAddon
	{
		...
		public override void SetStaticDefaults()
		{
			...
			VIB = true;
			vibOverride = ModContent.ProjectileType<LightBeamShot>();
			ArrayPassive = false;
		...
		public override void VIBShoot(Item item, Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback, string bonusFileMod = "", float multiplier = 1)
		{
			...
			LightBeamShot tasteTheRainbow = Projectile.NewProjectileDirect(source, position, velocity, ModContent.ProjectileType<LightBeamShot>(), damage, knockback).ModProjectile as LightBeamShot;
	...
	public class LightBeamShot : MProjectile
	{
		public string fileMod = "";
		public override string Texture => $"{Mod.Name}/Assets/Textures/BeamAddons/LightBeam/Shot";
	...
	public class LightBeamChargeShot : MProjectile
	{
		public string fileMod = "";
		public override string Texture => $"{Mod.Name}/Assets/Textures/BeamAddons/LightBeam/ShotCharged";
		public ModBeamAddon[] beamAddons = new ModBeamAddon[BeamAddonSlotID.Count - 1];
		public override void SetDefaults()
		{
			Projectile.width = 32;
