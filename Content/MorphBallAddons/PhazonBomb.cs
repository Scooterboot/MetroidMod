...
namespace MetroidMod.Content.MorphBallAddons
{
	public class PhazonBomb : ModMBWeapon
	{
		...
		public override bool CanGenerateOnChozoStatue(int x, int y) => ((WorldGen.drunkWorldGen || WorldGen.everythingWorldGen) && Common.Configs.MConfigMain.Instance.drunkWorldHasDrunkStatues) || NPC.downedPlantBoss;
