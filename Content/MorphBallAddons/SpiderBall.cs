...
namespace MetroidMod.Content.MorphBallAddons
{
	public class SpiderBall : ModMBUtility
	{
		...
		public override double GenerationChance(int x, int y) => (WorldGen.drunkWorldGen || WorldGen.everythingWorldGen) && Common.Configs.MConfigMain.Instance.drunkWorldHasDrunkStatues ? 20 : 15;
