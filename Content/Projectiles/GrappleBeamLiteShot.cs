...
{
	public class GrappleBeamLiteShot : ModProjectile
	{
		...
		internal int[] GrappableBlocks = new int[]
		{
			ModContent.TileType<Content.Tiles.GrappleTile>()
		};
