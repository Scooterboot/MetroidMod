...
namespace MetroidMod.Content.Projectiles
{
	public class ShaderTestProj : ModProjectile
	{
		...
		public override bool PreDraw(ref Color lightColor)
		{
			...
			data = new DrawData(tex, drawPos, new Rectangle?(new Rectangle(0, y4, tex.Width, frameHeight)), Color.White, Projectile.rotation, new Vector2((float)tex.Width / 2f, (float)frameHeight / 2f), Projectile.scale, effects);
