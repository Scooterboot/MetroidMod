...
namespace MetroidMod.Content.SuitAddons
{
	public class SpeedBooster : ModSuitAddon
	{
		...
		public override bool CanGenerateOnChozoStatue(int x, int y) => ((WorldGen.drunkWorldGen || WorldGen.everythingWorldGen) && Common.Configs.MConfigMain.Instance.drunkWorldHasDrunkStatues) || MSystem.bossesDown.HasFlag(MetroidBossDown.downedSerris);
