...
namespace MetroidMod.Content.SuitAddons
{
	public class GravitySuitAddon : ModSuitAddon
	{
		...
		public override bool CanGenerateOnChozoStatue(int x, int y) => Common.Configs.MConfigMain.Instance.drunkWorldHasDrunkStatues || MSystem.bossesDown.HasFlag(MetroidBossDown.downedPhantoon) && NPC.downedMechBossAny;
