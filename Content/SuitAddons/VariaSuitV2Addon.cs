...
{
	public class VariaSuitV2Addon : ModSuitUpgrade, IGeneratesOnStatues
	{
		...
		{
			return Common.Configs.MConfigMain.Instance.drunkWorldHasDrunkStatues || MSystem.bossesDown.HasFlag(MetroidBossDown.downedKraid)
				? 4
				: 0
				;
		}
