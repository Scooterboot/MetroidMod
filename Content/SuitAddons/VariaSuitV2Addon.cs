...
namespace MetroidMod.Content.SuitAddons
{
	public class VariaSuitV2Addon : ModSuitAddon
	{
		...
		public override bool CanGenerateOnChozoStatue(int x, int y) => ((WorldGen.drunkWorldGen || WorldGen.everythingWorldGen) && Common.Configs.MConfigMain.Instance.drunkWorldHasDrunkStatues) || MSystem.bossesDown.HasFlag(MetroidBossDown.downedKraid);
