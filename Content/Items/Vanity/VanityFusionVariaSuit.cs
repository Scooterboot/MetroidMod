...
namespace MetroidMod.Content.Items.Vanity
{
	...
	public class VanityFusionVariaSuitBreastplate : ModItem
	{
	...
	public class VanityFusionVariaSuitGreaves : ModItem
	{
		public override void SetStaticDefaults()
		{
			Item.ResearchUnlockCount = 1;
	...
	public class VanityFusionVariaSuitHelmet : ModItem
	{
		public override void SetStaticDefaults()
		{
			Item.ResearchUnlockCount = 1;
