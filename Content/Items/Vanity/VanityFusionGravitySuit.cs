...
namespace MetroidMod.Content.Items.Vanity
{
	...
	public class VanityFusionGravitySuitBreastplate : ModItem
	{
	...
	public class VanityFusionGravitySuitGreaves : ModItem
	{
		public override void SetStaticDefaults()
		{
			Item.ResearchUnlockCount = 1;
	...
	public class VanityFusionGravitySuitHelmet : ModItem
	{
		public override void SetStaticDefaults()
		{
			Item.ResearchUnlockCount = 1;
