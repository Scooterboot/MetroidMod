...
namespace MetroidModPorted.Content.Items.Vanity.Suits
{
	...
	{
		public override string Texture => $"{nameof(MetroidModPorted)}/Assets/Textures/SuitAddons/StardustAugment/StardustAugmentBreastplate";
	...
	{
		public override string Texture => $"{nameof(MetroidModPorted)}/Assets/Textures/SuitAddons/StardustAugment/StardustAugmentGreaves";
		public override void SetStaticDefaults()
		{
	...
	{
		public override string Texture => $"{nameof(MetroidModPorted)}/Assets/Textures/SuitAddons/StardustAugment/StardustAugmentHelmet";
		public override void SetStaticDefaults()
		{
